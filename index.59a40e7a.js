...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    window.onload = function() {
        ...
        imagesLoaded(images, {
            ...
            const onLoadTl = (0, _gsapDefault.default).timeline();
            onLoadTl.to(".overlay", {
                y: 0,
                duration: 0.1
            });
            ...
            function mainTl() {
                (0, _gsapDefault.default).timeline().to(".grid__item--title span", {
                    opacity: 1,
                    x: 0,
                    stagger: -0.1,
                    duration: .6
...
},{"gsap":"fPSuC","imagesloaded":"aYzyZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["5uAhr","8lRBv"], "8lRBv", "parcelRequire3767")
